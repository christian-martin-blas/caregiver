...
/* AcmeAdminBundle:Admin:index.html.twig */
class __TwigTemplate_cb6d06516435866cf71465f90d6c3a74 extends Twig_Template
{
...
";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "residents"));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "item"), "cognoms"), "html", null, true);
            echo "</a></li>
";
        }
...
<input type=\"button\" onclick=\" location.href='";
    ...
    {
        return "AcmeAdminBundle:Admin:index.html.twig";
    }
    ...
    {
        return array (  72 => 22,  68 => 20,  53 => 18,  49 => 17,  38 => 9,  34 => 8,  30 => 7,  26 => 6,  19 => 1,);
    }
}
